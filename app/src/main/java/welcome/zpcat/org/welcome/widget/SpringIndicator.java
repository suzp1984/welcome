...
package welcome.zpcat.org.welcome.widget;
...
import welcome.zpcat.org.welcome.R;
...
public class SpringIndicator extends FrameLayout {
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        mPointBg = a.getDrawable(R.styleable.SpringIndicator_sPointBg);
        a.recycle();
    ...
    private void addTabItems() {
        ...
        layoutParams.gravity = WindowManager.LayoutParams.LAY
        ...
        for (int i = 0; i < viewPager.getAdapter().getCount(); i++) {
            ...
            textView.setBackgroundResource(R.drawable.ic_guide_orange_point);
